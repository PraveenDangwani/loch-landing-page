...
const WatchWhalesSection = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 mb-4 lg:mb-0 lg:grid-cols-2 w-full">
      ...
      <div className="order-1 md:pt-10 md:order-2 ml-6 md:ml-0 md:pr-16 flex flex-col justify-start items-start md:items-end lg:items-end text-left md:text-right lg:text-right p-2 m-2 lg:m-0 space-y-2">
