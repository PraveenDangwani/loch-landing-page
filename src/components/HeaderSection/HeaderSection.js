...
const HeaderSection = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 w-full">
      ...
      <div className="px-6 lg:px-5 lg:py-0 lg:my-0 p-2 m-2 lg:pt-4 lg:mt-6">
        <img src={BellIcon} alt="bell icon" className="w-8 h-8 mb-4" />
        
        <h4 className="font-inter mr-3 font-light text-[28px] lg:text-[31px] leading-[120%] text-white mb-4">
